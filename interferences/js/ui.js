...
//  bouge pas (le mode n'a aucun effet caméra, cf. scene.js → ECHELLE_ANGLE_FACTEUR_MAX) ;
//  l'écran, la table, l'enveloppe et les rayons (cf. scene.js → facteurLargeurEchelle) doivent,
//  eux, être reconstruits explicitement (updateSceneParams() n'est pas rappelée à chaque frame).
